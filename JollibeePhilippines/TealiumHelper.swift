...
enum TealiumConfiguration {
    static let account = "sales-ruby-cheung"
    static let profile = "jollibee-mobile"
    static let environment = "dev"
    static let dataSourceKey = "3km96r"
}
...
//        config.collectors = [Collectors.Attribution, Collectors.VisitorService, Collectors.Location]
        config.collectors = [Collectors.VisitorService, Collectors.Lifecycle, Collectors.AppData, Collectors.Device]
